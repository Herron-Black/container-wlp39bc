...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-wlp39bc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-wlp39bc.containers.anotherwebservice.com/
...
```
git clone git@github.com:Herron-Black/container-wlp39bc.git
cd container-wlp39bc
```
...
```
docker attach container-wlp39bc
```
